          ...
          list_items.push(
            <li key={i}>
              <div style={listItemStyle}>
                <Link style={{ "float": "left" }} to={path}>{this.state.lists[i].fields.name}</Link>&nbsp;
                <input style={{ "float": "right" }} type="button" data-id={list_id} value="delete" onClick={this.deleteList} />&nbsp;
              </div>
            </li>
          );
        }
